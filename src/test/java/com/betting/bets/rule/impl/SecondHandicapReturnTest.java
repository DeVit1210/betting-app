...
@SpringBootTest
class SecondHandicapReturnTest extends RuleTest {
    @Mock
    private HandicapExpression expression;
    @TestConfiguration
    static class SecondHandicapReturnTestConfig {
        @Bean
        public Rule rule() {
            return new SecondHandicapReturn();
        }
    }

    @Test
    void evaluateWhenSecondHasHandicapEqualToDifference() {
